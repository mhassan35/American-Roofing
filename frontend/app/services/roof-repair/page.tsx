...
function DefaultRoofRepairContent() {
  return (
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="space-y-6">
          ...
          <h1 className="text-3xl font-bold text-gray-900">Expert Roof Repair Services</h1>
          <p className="text-lg text-gray-600">
            Fast, reliable repairs for leaks, damaged shingles, and other roofing issues throughout Houston.
          </p>
        </div>
      </div>
    </section>
...
function ServiceContent({ content }: { content: any }) {
  const title = content?.title || "Expert Roof Repair Services"
